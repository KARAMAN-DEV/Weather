...
class WeatherService {
  ...
  Future<List<WeatherModel>> getWeatherData() async {
    ...
    const Map<String, String> headers = {
      "authorization": "apikey 5MIcLcBvt1XqFznSSXZVRN:1vZ93J176dxezJy8CaV8L7",
      "content-type": "application/json"
    };

    final dio = Dio();
    final responce = await dio.get(url, options: Options(headers: headers));

    if (responce.statusCode != 200) {
      return Future.error("Bir sorun oluştu.");
    }
    final List list = responce.data['result'];
